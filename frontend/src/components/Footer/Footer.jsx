        ...
        <Row>
            ...
            <div className="logo footer__logo">
              <h1>
                <Link to="/home" className=" d-flex align-items-center gap-2">
                  ...
                  <span>
                    Anant Car Wash <br /> and Services
                  </span>
                </Link>
              </h1>
            </div>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Beside Saint Merry Church,Panjim,Goa</p>
              <p className="office__info">Phone: +91 98222 17333</p>

              <p className="office__info">Email: anantcarwash@services.com</p>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                Developed by
                Varad J,Nikhil M,Nikhil N,Divya B.
                All rights reserved.
              </p>
            </div>
          </Col>
