...
<section className="vh-100">
  ...
  <input class="form-check-input" type="radio" name="inlineRadioOptions" id='roles' value="1"  onChange={(e) => setRoles(e.target.value)}/>
  <label class="form-check-label" for="roles">Customer</label>
</div>
<div class="form-check form-check-inline">
  <input class="form-check-input" type="radio" name="inlineRadioOptions" id='roles' value="2"  onChange={(e) => setRoles(e.target.value)}/>
